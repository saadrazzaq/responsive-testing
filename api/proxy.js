...
// touch/pointer traits and DPR/pointer/hover media queries. (Width is emulated
// by the frame size; CSS srcset/backing-store DPR can't be overridden from a
// page and are the one gap versus real hardware.)
